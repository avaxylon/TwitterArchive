...
public class Twitter_loop_streaming {
    ...
    public void loadMenu() throws InterruptedException {
       ...
       connectdb(keyword);
            ...
            cb.setOAuthConsumerKey("xOX2O1icrHI3PiZd3ZJwwMFvO");
            cb.setOAuthConsumerSecret("3Y6ecye4GabbfhqZoGQzt2tPAnfuPwiYlYjWrjPpfC577NV8Jb");
            cb.setOAuthAccessToken("3929604674-KoMoTDbhzVyyUpldG2bJn3QfxjF9FT3IW6tdEqI");
            cb.setOAuthAccessTokenSecret("4hZ1TYD8prsC5QeZvfSHbBfumxh1Yb6ykRW42Gh8x8A0f");
